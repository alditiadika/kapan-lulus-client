...
class ProfileComplete extends React.Component {
  render() {
    ...
    //   console.log({ y: window.pageYOffset, height: window.scrollY });
    // });
    return (
      <Container>
        <Row>
            ...
            <Card style={{ marginBottom: "10px" }}>
              <CardBody>
                ...
                <div className="text-center">
                  ...
                  <a href="#!">Mahasiswa {this.props.auth.user.department}</a>
                  <br />
                  <a href="#!">{this.props.auth.user.university}</a>
                  <br />
            ...
            <Card style={{ marginBottom: "10px" }}>
              <CardBody>
                <Row style={{ marginBottom: "10px" }}>
                  ...
                  <Col>
                    <a href="#!">{this.props.auth.user.topic}</a>
                  </Col>
                </Row>
                <Row>
              ...
              <CardFooter>
                <div className="text-center">
                  <a href={`/profile-${this.props.auth.user._id}`}>
